...
public class CourseTest {
    ...
    @Test
    public void testGetNumStudents1() throws IOException {
        int numStudents = course.getNumStudents();
        assertEquals(16, numStudents);
    }

    @Test
    public void testGetNumAssignments1() throws IOException {
        int numAssignments = course.getNumAssignments();
        assertEquals(3, numAssignments);
    }

    @Test
    public void testGetNumProjects1() throws IOException {
        int numProjects;
    ...
    @Test
    public void testGetStudents2() throws IOException {
        HashSet<Student> studentsRoster = null;
        studentsRoster = course.getStudents();
    ...
    @Test
    public void testGetStudentsByName1() throws IOException {
        Student student = null;
    ...
    @Test
    public void testGetStudentsByName2() throws IOException {
        Student student = null;
    ...
    @Test
    public void testGetStudentsByID1() throws IOException {
        Student student = course.getStudentByID("901234504");
        assertEquals("Shevon Wise", student.getName());
    }

    @Test
    public void testGetTeam1() throws IOException {
    ...
    // New tests
    @Test
    public void testAddAssignment() throws IOException {
    ...
    @Test
    public void testAddGradesForAssignment() throws IOException {
    ...
    @Test
    public void testGetAverageAssignmentsGrade() throws IOException {
    ...
    @Test
    public void testGetAverageProjectsGrade() throws IOException {
        // Rounded to the closest integer
    ...
    @Test
    public void testAddIndividualContributions() throws IOException {
    ...
    @Test
    public void testFormulaUpdate1() throws GradeFormulaException, ScriptException, IOException {
    ...
    @Test
    public void testFormulaUpdate2() throws GradeFormulaException, ScriptException, IOException {
    ...
    public void testFormulaUpdate3() throws GradeFormulaException, ScriptException, IOException {
