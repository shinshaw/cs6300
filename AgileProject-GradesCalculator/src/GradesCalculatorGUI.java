...
public class GradesCalculatorGUI {
	...
	public GradesCalculatorGUI(String studentsdbfile, String gradesdbfile) throws IOException {
		...
		formulaField.setText(grades.getFormula());
	...
	protected void updateFormula() throws IOException{
		grades.setFormula(formulaField.getText());
		refreshStudentInfo();		
		
	}

	private void refreshStudentInfo() throws IOException {
		String studentInfo = getStudentInfo();
		studentInfoArea.setText(studentInfo);
	}

	private void fillComboBox() throws IOException {
	...
	private String getStudentInfo() throws IOException {
